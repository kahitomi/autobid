...
def model_test():
	...
	with tf.Session() as sess:
		...
		model = Seq2SeqModel(input_size=5, output_size=5, bucket=bucket, size=100, num_layers=2, max_gradient_norm=5.0, batch_size=10, learning_rate=0.1, learning_rate_decay_factor=0.9)
